...
network.load_state_dict(torch.load('models/v4.6/classifier', map_location = lambda storage, loc : storage))
...
base = 'models/v4.6/plots'
if os.path.isdir(base):
    shutil.rmtree(base)
os.mkdir(base)
os.mkdir('models/v4.6/plots/0')
os.mkdir('models/v4.6/plots/1')
...
for index in range(test_X.shape[0]):
    ...
    for plot_index in plot_indices:
        ...
        plot_path = os.path.join('models/v4.6/plots/{}/{}.png'.format(plot_index, index))
        print(plot_path)
