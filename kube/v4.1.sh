...
python -u models/v4.1/classifier_train.py --epochs 25 --lr 0.001 --batch_size 32 --num_maps 8 --patience 5 --limit 3 --save_model 'models/v4.1/classifier' &> models/v4.1/log_train
python -u models/v4.1/classifier_test.py --batch_size 10 --num_maps 8 --load_model 'models/v4.1/classifier' --save_results 'models/v4.1/results' &> models/v4.1/log_test
