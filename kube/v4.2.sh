...
python -u models/v4.2/classifier_train.py --epochs 50 --lr 0.001 --batch_size 16 --patience 15 --limit 3 --save_model 'models/v4.2/classifier' &> models/v4.2/log_train
python -u models/v4.2/classifier_test.py --batch_size 10 --load_model 'models/v4.2/classifier' --save_results 'models/v4.2/results' &> models/v4.2/log_test
