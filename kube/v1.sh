...
python -u models/v1/classifier_train.py --epochs 20 --lr 0.001 --batch_size 20 --num_maps 3 --patience 10 --limit 4 --save_model 'models/v1/classifier' &> models/v1/log_train
