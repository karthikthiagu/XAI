...
python -u models/v1/classifier_train.py --epochs 100 --lr 0.001 --batch_size 16 --num_maps 8 --patience 10 --limit 4 --save_model 'models/v1/classifier' &> models/v1/log_train
